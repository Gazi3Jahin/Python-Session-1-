...
def compound_interest(P,r,n,t):#principal-P, rate-r, time-t, periods-n
...
print("The amount of money accumulated after interest is:", round(result, 2))
...
while True:
    ...
    print("Current time:", current_time.strftime("%Y-%m-%d %H:%M:%S"), end="\r")
    time.sleep(1)
