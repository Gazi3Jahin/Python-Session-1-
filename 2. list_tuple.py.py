...
mixed_tuple = ("Jahin", 23, True, 2024)

data = {
    mixed_tuple: "Information about Jahin"
}

print("Information about Jahin:", data[mixed_tuple])

person_data = {
    "name": mixed_tuple[0],
    "age": mixed_tuple[1],
    "is_student": mixed_tuple[2],
    "study_year": mixed_tuple[3]
}

print("Name:", person_data["name"])
print("Age:", person_data["age"])
print("Is Student:", person_data["is_student"])
print("study_year:", person_data["study_year"])
...
print("Sorted list of student grades:")
